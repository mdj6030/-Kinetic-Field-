...
CREATE TABLE IF NOT EXISTS screen_capture_grants (
  id            UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
-- =====================================================================
CREATE TABLE IF NOT EXISTS institutions (          -- نوع المؤسسة التعليمية
  id        UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE TABLE IF NOT EXISTS specialties (           -- التخصص / الكلية
  id             UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE TABLE IF NOT EXISTS stages (                -- المرحلة الدراسية
  id         UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
-- =====================================================================
CREATE TABLE IF NOT EXISTS course_sections (       -- الأقسام (Introduction / Chapter N)
  id          UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE TABLE IF NOT EXISTS code_share_links (      -- "Enable other sharing options" — قابل للتوسعة
  id          UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE TABLE IF NOT EXISTS contract_enforcement_actions (
  id            UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  teacher_id    UUID NOT NULL REFERENCES users(id),
